...
int main()
{
    ...
    string input_csv;
    string output_csv;
    for (int y = 2009; y <= 2009; y++)
    {

        string input_name = "D:/LAB/c++/QTS/DJI_30/Y2Y/train_";
        string input_format = " Q1).csv";
        stringstream ss_input;
        ss_input << input_name << y << "(" << y << input_format;
        input_csv = ss_input.str();

        string output_name = "train_result/Y2Y/train_";
        string output_format = " Q1)_result.csv";
        stringstream ss_output;
        ss_output << output_name << y << "(" << y << output_format;
        ...
        //cout << EXP_Gbest << "  " << GEN_Gbest << endl;
        //cout << fundings(Gglobalbest) << endl;
        /*name.clear();
        data.clear();
        inFile.close();*/
    }
...
double fundings(vector<int> num)
{
    ...
    else
    {
        ...
        /*for (int i = 0; i < tempdata[0].size(); i++) //day
        {
            cout << i + 1 << ": " << fixed << setprecision(10) << funding[i] << endl;
        }*/
        ...
        for (int i = 0; i < tempdata[0].size(); i++)
        {
            ...
            cout << "+: " << (i + 1) * funding[i] << " - " << (i + 1) * allmoney << endl;
